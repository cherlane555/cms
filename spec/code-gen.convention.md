...
## Backend
  ...
  - `DateOnly`/`TimeOnly` fields: register Dapper type handlers in `Program.cs` — not done yet for
    any entity as of this writing; you'll be the first, see scaffolding-notes.md
